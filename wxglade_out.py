...
# -*- coding: UTF-8 -*-
#
# generated by wxGlade 0.9.5 on Sat Apr 11 00:20:07 2020
#
...
class MainFrame(wx.Frame):
    def __init__(self, *args, **kwds):
        ...
        self.toolbar.AddTool(wx.ID_REDO, _(u"Повторить"), wx.Bitmap("icons\\repeat.png", wx.BITMAP_TYPE_ANY), wx.Bitmap("icons\\repeat.disabled.png", wx.BITMAP_TYPE_ANY), wx.ITEM_NORMAL, _(u"Повторить"), "")
        self.toolbar.AddSeparator()
    ...
    def __do_layout(self):
        ...
        sizer_1.Add(self.panel, 0, wx.ALL | wx.EXPAND | wx.FIXED_MINSIZE, 0)
